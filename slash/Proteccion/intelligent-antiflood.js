...
module.exports = {
  ...
  async execute(interaction, _guild) {
    ...
    if (interaction.user.id !== interaction.guild.ownerId) {
      return interaction.reply({ content: 'Solo el propietario del servidor puede usar este comando.', ephemeral: true });
    }

    if (!_guild.protection) _guild.protection = {};
    if (typeof _guild.protection.intelligentAntiflood !== 'boolean') {
