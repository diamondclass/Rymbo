...
module.exports = {
  ...
  async execute(interaction, _guild) {
    ...
    if (!interaction.guild.members.me.permissions.has(PermissionsBitField.Flags.BanMembers)) 
      return interaction.reply({ content: 'Necesito el permiso para __Banear miembros__.', ephemeral: true });
    if (!interaction.member.permissions.has(PermissionsBitField.Flags.BanMembers)) 
      return interaction.reply({ content: 'Necesitas el permiso para __Banear miembros__.', ephemeral: true });

    if (!_guild.protection) _guild.protection = {};
    if (!_guild.protection.antijoins) _guild.protection.antijoins = { enable: false };
